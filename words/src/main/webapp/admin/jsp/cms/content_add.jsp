...
<form class="layui-form layui-form-pane" method="post" enctype="multipart/form-data"
      action="/admin/content/add" id="form1">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="createTime" id="createDatetime" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <select name="channelId" lay-verify="required" id="channel_id">
                <option value=""></option>
            </select>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="mediaPath" lay-verify="required" autocomplete="off" class="layui-input" id="mediaPath" value="-">
        </div>
        <div class="layui-input-inline">
            ...
            $.ajax({
                ...
                success:function(d){
                    if(d.code != 200){
                        ...
                        parent.closeWin("contentAddWin","contentStore");
                    }
                }
            });
            return false;
            ...
            $.ajax({
                ...
                success:function(res){
                    if(res.code==200){
                        ...
                        $('#channel_id').append(option);　　// 给select节点追加
                        form.render('select');
                    }
                }
            });
